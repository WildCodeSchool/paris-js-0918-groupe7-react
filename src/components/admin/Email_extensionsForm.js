...
class EmailExtensionForm extends React.Component{
...
EmailExtensionForm.propTypes = {
    classes: PropTypes.object.isRequired,
  };

export default withStyles(styles)(EmailExtensionForm);
