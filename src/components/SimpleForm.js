...
componentDidMount() {
  const urlA = 'http://localhost:3002/agencies';
  const urlC = 'http://localhost:3002/companies';
  const urlP = 'http://localhost:3002/poles';
  Axios.get(urlA)
...
render() {
  if (this.state.agencies === null || this.state.companies === null || this.state.poles === null) { return ('loading.....'); }
      ...
      <div>
        ...
        <div>
          <Field 
            ...
            validate={[required]}>
            <option />
            {age_range.map((e, i) => <option key={i}>{e.value}</option>)}
          </Field>
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <Field 
            ...
            validate={[required]}>
            <option />
            {this.state.companies.map((e, i) => <option key={i}>{e.name}</option>)}
          </Field>
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <Field name="agency" component="select" className="widthInput">
            <option />
            {this.state.agencies.map((e, i) => <option key={i}>{e.name}</option>)}
          </Field>
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <Field name="department" component="select" className="widthInput">
            <option />
            {this.state.poles.map((e, i) => <option key={i}>{e.name}</option>)}
          </Field>
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <Field name="business_focus" component="select" className="widthInput">
            <option />
            {business_focus.map((e, i) => <option key={i}>{e.value}</option>)}
          </Field>
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <Field name="seniority" component="select" className="widthInput">
            <option />
            {seniority.map((e, i) => <option key={i}>{e.value}</option>)}
          </Field>
        </div>
      </div>
