...
handleContinue = () => {
    ...
    this.setState({subPillarId : this.state.subPillarId +1 },()=>{ 
        this.setState({
            questionsReponses: this.state.data.pole.pillars[this.state.pillarId].sub_pillars[this.state.subPillarId].questions, 
    ...
    render(){
        ...
        if(this.state.thanksPage)
            return (
                <div>
                    <BarProgress data={this.state.data.pole.pillars} step={this.state.length+2} />
        ...
        if(this.state.validationPage)
            return (
                <div>
                    <BarProgress data={this.state.data.pole.pillars} step={this.state.length+1} />
                    <ValidationPage thanksPage={this.goToThanksPage}/>
                </div>
            )
        return(
            <div>
                <Grid container>
                <BarProgress data={this.state.data.pole.pillars} step={this.state.length} />
